...
//We create a function "deleteParameter" we will use to delete the parameters
function deleteParameter($client){
    try {
        //We create the array to be sent. In this case I'm identifying the parameter by Name
